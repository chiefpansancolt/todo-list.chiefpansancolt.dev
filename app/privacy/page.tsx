      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <div className="mb-8 rounded-lg bg-gray-50 p-6 dark:bg-gray-800">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            principle. We do not collect, store, transmit, or have access to any
            of your personal data. All information you enter into the
            application remains locally on your device.
          </p>
        </div>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            All data created within the Todo List application is stored locally
          ...
          <ul className="list-inside list-disc space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              <strong>No cloud synchronization:</strong> Data never leaves your
              device unless you explicitly export it
            </li>
            <li>
              <strong>User-controlled backups:</strong> You can export your data
              as JSON or CSV files for backup purposes
            </li>
            <li>
              <strong>Complete ownership:</strong> You have full control over
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            The Todo List application operates completely offline and does not
            make any network connections for:
          </p>
          <ul className="list-inside list-disc space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <p className="mt-4 text-gray-700 dark:text-gray-300">
            The only network activity occurs when you manually check for updates
            through our website or GitHub releases page.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            The Todo List application does not integrate with or send data to
            any third-party services, including:
          </p>
          <ul className="list-inside list-disc space-y-2 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Any updates to this privacy policy will be posted on our website and
            GitHub repository. Given the nature of our application (no data
            collection), changes to this policy are expected to be minimal and
            will always maintain our commitment to user privacy.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Our application is open source, meaning you can review our code to
            verify our privacy claims. The source code is available at{" "}
