import { HiSparkles, HiCalendar, HiCog } from "react-icons/hi";
import { FaGithub, FaDiscord, FaBug } from "react-icons/fa6";
    ...
    <PageLayout>
      ...
      <div className="mt-16 rounded-lg p-8 text-center">
        ...
        <p className="mb-6 text-gray-600 dark:text-gray-300">
          Follow our GitHub repository to get notified about new releases and
          updates.
        </p>
