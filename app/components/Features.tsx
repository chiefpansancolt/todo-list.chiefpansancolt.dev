			...
			<div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
				<div className="mb-8 max-w-screen-md lg:mb-16">
					...
					<p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
						Experience the perfect balance between simplicity and functionality. Our app
						brings together essential task management features with an intuitive
						interface that adapts to your workflow.
					</p>
				</div>
