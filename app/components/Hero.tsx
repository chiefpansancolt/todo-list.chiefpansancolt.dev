...
export default function Hero() {
	...
	const handleDownload = () => {
		if (detectPlatform() === "linux") {
			...
			handlePlatformDownload(detectPlatform(), latestRelease || undefined, undefined);
		}
	};
			...
			<div className="mx-auto mt-14 grid max-w-screen-xl px-4 py-8 lg:mt-0 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
				<div className="mr-auto place-self-center lg:col-span-7">
					...
					<p className="mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl dark:text-gray-400">
						Today todo list trackers are either too barebones or too complicated. This
						app takes those two ends and finds a middle ground where you have
						flexibility with the combo of simple to help make managing tasks simple and
						easy again.
					</p>
