			...
			<div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
				<div className="text-center">
					...
					<p className="mx-auto mb-8 max-w-2xl text-lg text-gray-600 dark:text-gray-300">
						Everything you need to know about the Todo List Desktop app. Can&apos;t find
						what you&apos;re looking for? Feel free to reach out to our Discord Server.
					</p>
				</div>
				...
				<div className="mt-12 rounded-lg p-8 text-center">
					...
					<p className="mb-6 text-gray-600 dark:text-gray-300">
						We&apos;re here to help! Reach out on our Discord Server for a community to
						help.
					</p>
